...
function docs_load(path) {
    ...
    '<rect width="640" height="240" fill="white" /><path d="M 64 192 H 320" stroke="#FF2222" stroke-width="8"></path><path d="M 320 192 H 704" stroke="#2222FF" stroke-width="8"></path>' +
    ...
    '<a xlink:href="' + path + '/user_guide.html"><g><circle cx="320" cy="192" r="6" fill="#FFFFFF" stroke="#000000" stroke-width="2"></circle><text x="320" y="176" font-family="Arial" font-size="16px" fill="black" font-weight="bold" text-anchor="start" dominant-baseline="alphabetic" transform="rotate(-45 320 176)">User Guide</text></g></a>' +
